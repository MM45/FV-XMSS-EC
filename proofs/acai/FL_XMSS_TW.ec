...
have ->: Pr[EUF_RMA_FLXMSSTWES_NOPRF_Conditions.main() @ &m:
                (res /\ !EUF_RMA_FLXMSSTWES_NOPRF_Conditions.valid_WOTSTWES)
             /\ EUF_RMA_FLXMSSTWES_NOPRF_Conditions.coll_pkco]
       = Pr[EUF_RMA_FLXMSSTWES_NOPRF_Conditions.main() @ &m :
                res
             /\ !EUF_RMA_FLXMSSTWES_NOPRF_Conditions.valid_WOTSTWES
             /\ EUF_RMA_FLXMSSTWES_NOPRF_Conditions.coll_pkco].
+ byequiv=> /> => [/#|].
  by conseq (: ={res, EUF_RMA_FLXMSSTWES_NOPRF_Conditions.valid_WOTSTWES, EUF_RMA_FLXMSSTWES_NOPRF_Conditions.coll_pkco})=> [/#|]; sim.
